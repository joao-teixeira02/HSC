...
def main(args):
    ...
    if args.output == None: # HDMI output
...
if __name__ == "__main__":
    ...
    parser.add_argument('-p', dest='profile', action='store_true', default=False,
                        help='enable profiling (default: disabled)')  # New argument for profiling
    ...
    if args.profile:
        ...
        with open("profiling_report.txt", "w") as f:
            ...
            stats.sort_stats("calls").print_stats(15)
