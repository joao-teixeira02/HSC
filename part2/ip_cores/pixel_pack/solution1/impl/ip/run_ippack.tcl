...
set sdx_kernel_name "pixel_pack"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Users/PC/HSC/part2/ip_cores/pixel_pack/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {pixel_pack_AXILiteS_s_axi
regslice_core
pixel_pack
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 mode W 0x0 "Data signal of mode" {{0 32 mode W 0 "Bit 31 to 0 Data signal of mode"}}} {0x18 alpha_V W 0x0 "Data signal of alpha_V" {{0 8 alpha_V W 0 "Bit 7 to 0 Data signal of alpha_V"} {8 24 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
