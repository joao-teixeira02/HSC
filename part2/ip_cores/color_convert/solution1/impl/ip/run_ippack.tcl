...
set sdx_kernel_name "color_convert"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Users/PC/HSC/part2/ip_cores/color_convert/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {color_convert_macbkb
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 c1_c1_V W 0x0 "Data signal of c1_c1_V" {{0 10 c1_c1_V W 0 "Bit 9 to 0 Data signal of c1_c1_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x18 c1_c2_V W 0x0 "Data signal of c1_c2_V" {{0 10 c1_c2_V W 0 "Bit 9 to 0 Data signal of c1_c2_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x20 c1_c3_V W 0x0 "Data signal of c1_c3_V" {{0 10 c1_c3_V W 0 "Bit 9 to 0 Data signal of c1_c3_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x28 c2_c1_V W 0x0 "Data signal of c2_c1_V" {{0 10 c2_c1_V W 0 "Bit 9 to 0 Data signal of c2_c1_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x30 c2_c2_V W 0x0 "Data signal of c2_c2_V" {{0 10 c2_c2_V W 0 "Bit 9 to 0 Data signal of c2_c2_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x38 c2_c3_V W 0x0 "Data signal of c2_c3_V" {{0 10 c2_c3_V W 0 "Bit 9 to 0 Data signal of c2_c3_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x40 c3_c1_V W 0x0 "Data signal of c3_c1_V" {{0 10 c3_c1_V W 0 "Bit 9 to 0 Data signal of c3_c1_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x48 c3_c2_V W 0x0 "Data signal of c3_c2_V" {{0 10 c3_c2_V W 0 "Bit 9 to 0 Data signal of c3_c2_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x50 c3_c3_V W 0x0 "Data signal of c3_c3_V" {{0 10 c3_c3_V W 0 "Bit 9 to 0 Data signal of c3_c3_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x58 bias_c1_V W 0x0 "Data signal of bias_c1_V" {{0 10 bias_c1_V W 0 "Bit 9 to 0 Data signal of bias_c1_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x60 bias_c2_V W 0x0 "Data signal of bias_c2_V" {{0 10 bias_c2_V W 0 "Bit 9 to 0 Data signal of bias_c2_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}} {0x68 bias_c3_V W 0x0 "Data signal of bias_c3_V" {{0 10 bias_c3_V W 0 "Bit 9 to 0 Data signal of bias_c3_V"} {10 22 RESERVED R 0 "Reserved.  0s on read."}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
...
## System Info
set user_parameters_list {clk_period 7 machine 64 combinational 0 latency 6 II 1}
