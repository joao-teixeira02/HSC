...
set id 1
set name pixel_proc_fcmp_32ns_32ns_1_2_1
...
set id 4
set name pixel_proc_mul_62ns_8ns_69_6_1
...
set id 5
set name pixel_proc_mul_65ns_8ns_72_6_1
set corename simcore_mul
set op mul
set stage_num 6
set max_latency -1
...
set id 6
set name pixel_proc_mul_64ns_8ns_71_6_1
set corename simcore_mul
set op mul
set stage_num 6
set max_latency -1
...
set id 7
set name pixel_proc_mul_62s_8ns_70_6_1
set corename simcore_mul
set op mul
set stage_num 6
set max_latency -1
...
set id 8
set name pixel_proc_mul_64s_8ns_72_6_1
set corename simcore_mul
set op mul
set stage_num 6
set max_latency -1
...
set id 10
set name pixel_proc_mul_63s_8ns_71_6_1
set corename simcore_mul
set op mul
set stage_num 6
set max_latency -1
...
set id 11
set name pixel_proc_mul_66ns_96s_161_6_1
set corename simcore_mul
set op mul
set stage_num 6
set max_latency -1
...
set id 12
set name pixel_proc_mul_65s_96s_160_6_1
set corename simcore_mul
set op mul
set stage_num 6
set max_latency -1
...
set id 13
set name pixel_proc_mul_64s_96s_159_6_1
set corename simcore_mul
set op mul
set stage_num 6
set max_latency -1
...
set id 15
set name pixel_proc_mux_2569_22_1_1
...
set id 16
set name pixel_proc_mux_2569_32_1_1
set corename simcore_mux
set op mux
set stage_num 1
set max_latency -1
...
set id 21
set name pixel_proc_mux_648_32_1_1
set corename simcore_mux
set op mux
set stage_num 1
set max_latency -1
...
set id 23
set name pixel_proc_add_161ns_161ns_161_2_1
...
set id 24
set name pixel_proc_add_160ns_160ns_160_2_1
set corename simcore_add
set op add
set stage_num 2
set max_latency -1
...
set id 26
set name pixel_proc_add_161s_161s_161_2_1
set corename simcore_add
set op add
set stage_num 2
set max_latency -1
...
set ID 43
set hasByteEnable 0
set MemName pixel_proc_mask_table8
...
set ID 44
set hasByteEnable 0
set MemName pixel_proc_one_half_table9
set CoreName ap_simcore_mem
set PortList { 1 1 }
set DataWd 24
set AddrRange 32
...
if {${::AESL::PGuard_simmodel_gen}} {
	if {[info proc ::AESL_LIB_XILADAPTER::s_axilite_gen] == "::AESL_LIB_XILADAPTER::s_axilite_gen"} {
		eval "::AESL_LIB_XILADAPTER::s_axilite_gen { \
			id 45 \
			corename pixel_proc_AXILiteS_axilite \
			name pixel_proc_AXILiteS_s_axi \
			ports {$port_AXILiteS} \
			op interface \
			is_flushable 0 \ 
		} "
...
if {${::AESL::PGuard_rtl_comp_handler}} {
	::AP::rtl_comp_handler pixel_proc_AXILiteS_s_axi
}
...
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'video_in_data'"
}
}
...
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'video_in_user_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 48 \
    name video_in_last_V \
    reset_level 0 \
    sync_rst true \
    corename {video_in} \
    metadata {  } \
    op interface \
    ports { video_in_TVALID { I 1 bit } video_in_TREADY { O 1 bit } video_in_TLAST { I 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'video_in_last_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    ...
    metadata {  } \
    op interface \
    ports { video_out_TDATA { O 24 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'video_out_data'"
}
}
...
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'video_out_user_V'"
}
}
...
eval "::AESL_LIB_XILADAPTER::native_axis_add { \
    id 51 \
    name video_out_last_V \
    reset_level 0 \
    sync_rst true \
    corename {video_out} \
    metadata {  } \
    op interface \
    ports { video_out_TVALID { O 1 bit } video_out_TREADY { I 1 bit } video_out_TLAST { O 1 vector } } \
} "
} else {
puts "@W \[IMPL-110\] Cannot find bus interface model in the library. Ignored generation of bus interface for 'video_out_last_V'"
}
}
