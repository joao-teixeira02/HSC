...
entity pixel_proc_one_half_table9_rom is 
    generic(
             DWIDTH     : integer := 24; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of pixel_proc_one_half_table9_rom is 
...
entity pixel_proc_one_half_table9 is
    generic (
...
architecture arch of pixel_proc_one_half_table9 is
    component pixel_proc_one_half_table9_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pixel_proc_one_half_table9_rom_U :  component pixel_proc_one_half_table9_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
