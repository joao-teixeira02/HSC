...
entity pixel_proc_mask_table8_rom is 
    generic(
             DWIDTH     : integer := 23; 
             AWIDTH     : integer := 5; 
             MEM_SIZE    : integer := 32
...
architecture rtl of pixel_proc_mask_table8_rom is 
...
entity pixel_proc_mask_table8 is
    generic (
...
architecture arch of pixel_proc_mask_table8 is
    component pixel_proc_mask_table8_rom is
        port (
            clk : IN STD_LOGIC;
...
begin
    pixel_proc_mask_table8_rom_U :  component pixel_proc_mask_table8_rom
    port map (
        clk => clk,
        addr0 => address0,
        ce0 => ce0,
