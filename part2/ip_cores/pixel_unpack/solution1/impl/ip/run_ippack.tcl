...
set sdx_kernel_name "pixel_unpack"
set sdx_kernel_type ""
set sdx_kernel_files {}
set enable_xo_gen 0
set sdaccel_dir [file join [pwd] .. kernel]
set solution_dir "C:/Users/PC/HSC/part2/ip_cores/pixel_unpack/solution1"
set debug_dir [file join $solution_dir .debug]
set xo_hls_files_dir ""
set hdl_module_list {pixel_unpack_AXILiteS_s_axi
regslice_core
pixel_unpack
}
set kernel_xo ""
...
set Interfaces {
    s_axi_AXILiteS {
        ...
        registers {{0x10 mode W 0x0 "Data signal of mode" {{0 32 mode W 0 "Bit 31 to 0 Data signal of mode"}}}}
        memories ""
        ctype {
            AWVALID {
                Type "bool"
