...
HD_PWD='C:/Users/PC/HSC/part2/overlay/hsc_video/hsc_video.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log hsc_video_wrapper.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source hsc_video_wrapper.tcl -notrace
